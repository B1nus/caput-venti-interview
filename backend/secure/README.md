...
This is my first time using javascript/typescript and its ecosystem to make a webserver. It's easy to see why many people use this to write webservers when the ecosystem is so mature and helpfull. express, prisma, validator, api limiter, they are all super easy to use and cut down on development time and cost.
